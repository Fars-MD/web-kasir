...
const config = {
  ...
  warning: { Icon: AlertTriangle, border: 'border-l-blue-500', bg: 'bg-blue-50', iconColor: 'text-blue-500' },
}
...
export function Toast({ id, type, message }: ToastProps) {
  ...
  return (
    ...
    >
      ...
      <button onClick={() => removeToast(id)} aria-label="Tutup notifikasi" className="text-slate-400 hover:text-slate-600 transition-colors p-0.5">
